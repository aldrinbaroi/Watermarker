...
class WatermarkerTests {
    ...
    void manualText() {
        try {
            final String sourceFileName = "src/test/resources/pdfClown_userGuide.pdf";
            final String targetFileName = "src/test/resources/pdfClown_userGuide_watermarked.pdf";
