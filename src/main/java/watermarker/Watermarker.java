...
public class Watermarker {
    ...
    public static void satermarkPdfFile(final String watermarkText,
        ...
        try (PDDocument doc = PDDocument.load(sourcePdfFile)) {
            ...
            final float rgbRed = watermarkFont.getRgbColor().getRed();
            final float rgbGreen = watermarkFont.getRgbColor().getGreen();
            final float rgbBlue = watermarkFont.getRgbColor().getBlue();
            //
